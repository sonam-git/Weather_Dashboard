...
function loadSearchHistory() {
  var searchHistoryArray = JSON.parse(localStorage.getItem("searched-cities"));
...
function getCoordinates(city) {
  ...
  fetch(apiCoordinatesUrl)
    ...
    .then(function (city) {
      ...
      searchWeather(city.coord.lat, city.coord.lon);
    });
}
...
function displayWeather(data) {
  ...
  var currentWeatherHeadingEl = $("<h2>").text( city
  + "(" + currentDay + ")");
